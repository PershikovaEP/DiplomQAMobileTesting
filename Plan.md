...
1. Нажать ок
1. Проверяем, что не виден заголовок "День Рождения удал"
...
1. В боковой панели навигации выбрать экран Заявки
1. Нажать в аппбаре на иконку "создание заявки" 
1. Ввести в поле тема "ТестРедакт", плановая дата 10.10.2023, время "12.00", описание "тест"   
1. Нажать сохранить
...
1. В боковой панели навигации выбрать экран Заявки
1. Нажать в аппбаре на иконку "создание заявки" 
1. Ввести в поле тема "ТестОтмена, плановая дата 10.10.2023, время "12.00", описание "тест"   
1. Нажать сохранить
...
1. Проверить, что открылась ссылка "https://vhospiceorg/#/privacy-policy
...
1. Проверить, что открылась ссылка "https://vhospiceorg/#/terms-of-use
