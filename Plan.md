...
- создание заявки, редактирование заявки, добавление комментария в заявку, изменение статуса заявки, фильтрация претензий
...
1. Тестирование локализации и глобализации
...
1. Встроенный в Android Srudio эмулятор устройств на базе android
