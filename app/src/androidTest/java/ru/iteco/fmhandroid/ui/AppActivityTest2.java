    ...
    public void appActivityTest2() {
        ...
        ViewInteraction textInputEditText3 = onView(
                allOf(childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText3.perform(replaceText("login2"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.add_news_image_view), withContentDescription("������ ���������� �������"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.custom_app_bar_title_text_view), withText("��������"),
