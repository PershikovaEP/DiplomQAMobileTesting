...
Было обнаружено 13 дефектов в 40 тестах(приложение 2), что соответсвует 22% неуспешных тестов/78% успешных тестов.
...
Весь процесс проведения тестирования занял 64 часа:
* подготовка тестовой документации - 32 часов
* проведение ручного тестирования по составленным тест-кейсам - 8 часов
* написание и прогон автоматизированных тестов - 24 часа 
