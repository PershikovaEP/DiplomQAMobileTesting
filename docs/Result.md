файл файл Result.md, с коротким отчетом (сравнение ручного и автоматизированного тестирования, найденные проблемы);
...
В ходе тестирования было осуществлено ручное тестирование мобильного приложения "В хосписе" (183 теста) (приложение 1).

Было обнаружено 14 дефектов в 43 тестах(приложение 2), что соответсвует 23,5% неуспешных тестов/76,5% успешных тестов.
...
| 77 | Ввод в поле Исполнитель данных  с клавиатуры без использования выпадающего списка | отрицательно |
...
| 182 |Появление политики конфиденциальности и согласия на обработку персональных данных при старте приложения с согласием на обработку|отрицательно|
| 183 |Несогласие на обработку персональных данных при старте приложения|отрицательно|
...
Автоматизировано 30 тест-кейсов. Из них 24 успешных тестов, что составляет 80%, 6 неуспешных тестов, что составляет 20%.


Отчет Allure о прохождении автоматизированного тестирования
![image](https://github.com/PershikovaEP/DiplomQAMobileTesting/assets/103420483/039a9d9c-178d-483f-a72c-46206a06edad)